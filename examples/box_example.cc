...
//! [Create a box]
  ...
  auto size=box.Size();
  std::cout<<"\nDefault box size: \nLength: "<<size[0]<<" Width: "<<size[1]<<" Height: "<<size[2]<<std::endl;
...
//! [Set the material for the box]
  box.Material();
  std::cout<<"\nDefault box material: "<<box.Material().Name()<<std::endl;
  box.SetMaterial(gz::math::Material("wood"));
  std::cout<<"\nUpdated box material: "<<box.Material().Name()<<std::endl;
//! [Set the material for the box]
...
//! [Center of volume below the plain]
  ...
  std::cout<<"\nCenter of volume below: "<<std::endl;
  std::cout<<"x: "<<cov.value()[0]<<" y: "<<cov.value()[1]<<" z: "<<cov.value()[2]<<std::endl;
//! [Center of volume below the plain]
