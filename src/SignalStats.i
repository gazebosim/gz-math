...
namespace ignition
{
  namespace math
  {
    ...
    class SignalMaximum : public SignalStatistic
    {
    ...
    class SignalMean : public SignalStatistic
    {
      public: virtual double Value() const override;
      public: virtual std::string ShortName() const override;
      public: virtual void InsertData(const double _data) override;
    ...
    class SignalMinimum : public SignalStatistic
    {
      public: virtual double Value() const override;
      public: virtual std::string ShortName() const override;
      public: virtual void InsertData(const double _data) override;
    ...
    class SignalRootMeanSquare : public SignalStatistic
    {
      public: virtual double Value() const override;
      public: virtual std::string ShortName() const override;
      public: virtual void InsertData(const double _data) override;
    ...
    class SignalMaxAbsoluteValue : public SignalStatistic
    {
      public: virtual double Value() const override;
      public: virtual std::string ShortName() const override;
      public: virtual void InsertData(const double _data) override;
    ...
    class SignalVariance : public SignalStatistic
    {
      public: virtual double Value() const override;
      public: virtual std::string ShortName() const override;
      public: virtual void InsertData(const double _data) override;
