...
import gz
from gz.math9 import MassMatrix3d, Material, Planed, Sphered, Vector2d, Vector3d
...
class TestSphere(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        # Radius and mat
        sphere = Sphered(1.0, Material(gz.math9.MaterialType.WOOD))
        self.assertEqual(1.0, sphere.radius())
        self.assertEqual(Material(gz.math9.MaterialType.WOOD), sphere.material())

        sphere2 = Sphered(1.0, Material(gz.math9.MaterialType.WOOD))
        self.assertEqual(sphere, sphere2)

    def test_comparison(self):
        wood = Sphered(0.1, Material(gz.math9.MaterialType.WOOD))
        ...
        modified.set_material(Material(gz.math9.MaterialType.PINE))
        self.assertNotEqual(wood, modified)
    ...
    def test_mutators(self):
        ...
        sphere.set_material(Material(gz.math9.MaterialType.PINE))

        self.assertEqual(.123, sphere.radius())
        self.assertEqual(Material(gz.math9.MaterialType.PINE), sphere.material())
