...
from ignition.math import Angle, DiffDriveOdometry, IGNPI
...
class TestDiffDriveOdometry(unittest.TestCase):
    ...
    def test_diff_drive_odometry(self):
        ...
        wheelSeparation = 2.0
        wheelRadius = 0.5
        wheelCircumference = 2 * IGNPI * wheelRadius
        ...
        odom.update(Angle(1.0 * IGNPI / 180),
                    Angle(1.0 * IGNPI / 180),
                    time1 - startTime)
        self.assertEqual(0.0, odom.heading().radian())
        ...
        odom.update(Angle(2.0 * IGNPI / 180),
                    Angle(2.0 * IGNPI / 180),
                    time2 - startTime)
        self.assertEqual(0.0, odom.heading().radian())
