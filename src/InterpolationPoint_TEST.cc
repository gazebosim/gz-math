...
TEST(Interpolation, LinearInterpolate3D)
{
  ...
  EXPECT_NEAR(LinearInterpolate(first, last, vec, Vector3d{0.0, 0, 0}), 0, 1e-3);
  EXPECT_NEAR(LinearInterpolate(first, last, vec, Vector3d{1.0, 0, 0}), 2, 1e-3);
  EXPECT_NEAR(LinearInterpolate(first, last, vec, Vector3d{0.5, 0, 0}), 1, 1e-3);
}
